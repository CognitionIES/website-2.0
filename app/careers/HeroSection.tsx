      ...
      >
        ...
        >
          ...
          <motion.p
            ...
            className={`text-white/90 text-sm xs:text-base sm:text-lg md:text-xl lg:text-2xl font-light ${
              isMobile
                ? "max-w-full mb-6"
                : "max-w-3xl xs:max-w-4xl mx-auto mb-4 sm:mb-6 md:mb-8"
            } leading-relaxed`}
          >
            {SUBTITLE}
          </motion.p>
          <motion.p
            ...
            className={`text-white/80 text-xs xs:text-sm sm:text-base md:text-lg lg:text-xl font-medium ${
              isMobile
                ? "max-w-full mb-6"
