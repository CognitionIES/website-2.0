        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-lg text-[#5B5B5B] mb-4 font-light leading-relaxed">
              ...
              enhance efficiency, sustainability, and safety in transportation.
            </p>
            <p className="text-lg text-[#5B5B5B] font-light leading-relaxed">
              From electric vehicles and aerospace to rail and marine, we create
              next-gen mobility solutions tailored for the future.
            </p>
            <motion.span
              initial={{ width: 0 }}
              animate={{ width: "20%" }}
