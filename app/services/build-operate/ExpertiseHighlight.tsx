          ...
          <div className="lg:col-span-7">
            ...
            <div className="mb-8">
              <p className="text-xl text-slate-600 leading-relaxed mb-6">
                We successfully assembled and managed a dedicated team of 30+ professionals for a global client—proving our ability to scale with your ambitions.
              </p>
            ...
            <div className="grid sm:grid-cols-3 gap-6">
              <div className="group">
                ...
                <p className="text-sm text-slate-600 font-medium">Team Members Managed</p>
              </div>
              ...
              <div className="group">
                ...
                <p className="text-sm text-slate-600 font-medium">Years Combined Experience</p>
              </div>
              ...
              <div className="group">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div className="text-3xl font-bold text-[#003c46]">100%</div>
                </div>
                <p className="text-sm text-slate-600 font-medium">Project Success Rate</p>
              </div>
            </div>
          </div>
            ...
            <div className="relative">
              ...
              <div className="relative z-10 bg-white rounded-2xl p-8 shadow-[0_20px_40px_-12px_rgba(0,60,70,0.15)] border border-slate-200/50 transform lg:translate-x-8">
                <div className="mb-6">
                  ...
                  <h3 className="text-xl font-semibold text-slate-900 mb-3">Global Fintech Platform</h3>
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-3 bg-slate-50 rounded-lg">
                    <span className="text-sm text-slate-600">Team Assembly</span>
                    <span className="text-sm font-semibold text-[#003c46]">6 weeks</span>
                  </div>
                  <div className="flex items-center justify-between p-3 bg-slate-50 rounded-lg">
                    <span className="text-sm text-slate-600">Platform Launch</span>
                    <span className="text-sm font-semibold text-[#003c46]">8 months</span>
                  </div>
                  <div className="flex items-center justify-between p-3 bg-slate-50 rounded-lg">
                    <span className="text-sm text-slate-600">Ongoing Operations</span>
                    <span className="text-sm font-semibold text-[#003c46]">24/7 support</span>
                  </div>
                </div>
              </div>
